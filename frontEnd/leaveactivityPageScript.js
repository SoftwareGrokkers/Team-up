...
activityName.appendChild(document.createTextNode("Activity: " + activityData.Name));
activitytype.appendChild(document.createTextNode("Type: " + activityData.type));
activityLocation.appendChild(document.createTextNode("Location: " + activityData.location))
activityTime.appendChild(document.createTextNode("Time: " + activityData.time))
